...
Dez25=[2.123, 2.121, 2.113, 2.126, 2.147, 2.150, 2.168, 2.165, 2.172, 2.170, 2.168,
      2.164, 2.144, 2.134, 2.126, 2.134, 2.131, 2.119, 2.124, 2.123, 2.107]
MediaEuribor=round(np.mean(Dez25), 3)

ValorRemanescente=198527.83
PrestacaoFaltam=426

Jan26=[2.105, 2.104, 2.104, 2.103, 2.114, 2.116, 2.130, 2.143, 2.146, 2.141,
      2.143, 2.155, 2.151, 2.156, 2.149, 2.157, 2.156, 2.154, 2.149, 2.146, 2.158]
MediaEuribor=round(np.mean(Jan26), 3)
#print(MediaEuribor)

ValorRemanescente=193283.69
PrestacaoFaltam=425

Fev26=[2.154, 2.161, 2.171, 2.172, 2.152, 2.132, 2.114, 2.108, 2.131, 2.147, 2.155,
      2.159, 2.141, 2.137, 2.141, 2.145, 2.149, 2.139, 2.134, 2.128]
MediaEuribor=round(np.mean(Fev26), 3)


ValorRemanescente=193045.04
PrestacaoFaltam=424

Mar26=[2.131, 2.120, 2.135, 2.136, 2.139, 2.178, 2.295, 2.173, 2.225, 2.289, 2.312,
      2.333, 2.309, 2.317, 2.326, 2.406, 2.468, 2.589, 2.518, 2.502, 2.504, 2.529, 2.475]
MediaEuribor=round(np.mean(Mar26), 3)


ValorRemanescente=192805.73
PrestacaoFaltam=423
...
Mai26=[2.558, 2.523, 2.556, 2.522, 2.472, 2.492, 2.485, 2.548, 2.548, 2.562, 2.594, 2.619, 2.603]
